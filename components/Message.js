...
function Message({ user, message, messageId }) {
  ...
  return (
    <Container>
      ...
      >
        <Typography onClick={deleteMessage} className={classes.typography}>
          Delete Message
        </Typography>
      </Popover>
    </Container>
...
const Sender = styled(MessageElement)`
  ...
  &:hover ${OptionsIcon} {
    opacity: 1;
    background: #a1dfec;
    box-shadow: -10px 0px 8px 2px #a1dfec;
    color: black;
  }
`;
...
const Reciever = styled(MessageElement)`
  ...
  &:hover ${OptionsIcon} {
    opacity: 1;
    background: #eeeeee;
    box-shadow: -10px 0px 8px 2px #eeeeee;
    color: black;
